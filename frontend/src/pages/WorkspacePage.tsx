...
export default function WorkspacePage() {
  ...
  const [editedValue, setEditedValue] = useState<string>(MOCK_REVIEW_ITEMS[0]?.value ?? "");
  ...
  const currentItem = MOCK_REVIEW_ITEMS[currentIndex];
  const isDone = currentIndex >= MOCK_REVIEW_ITEMS.length;
  ...
  function handleNextStep() {
    ...
    setCurrentIndex((i) => Math.min(MOCK_REVIEW_ITEMS.length, i + 1));
  }
        ...
        <div style={styles.header}>
          ...
          <div style={styles.statusPill}>
            <div style={styles.stepControls}>
              ...
              <span>
                {!isDone
                  ? `Step ${currentIndex + 1} / ${MOCK_REVIEW_ITEMS.length}`
                  : "Complete"}
              </span>
          ...
          <div style={styles.card}>
            <div style={styles.cardHeader}>
              ...
              <span style={styles.stepText}>
                {isDone ? "0 remaining" : `${MOCK_REVIEW_ITEMS.length - currentIndex} remaining`}
              </span>
            </div>
              ...
              {!isDone ? (
                <>
                  <div style={styles.stepText}>
                    Review {currentIndex + 1} of {MOCK_REVIEW_ITEMS.length}
                  </div>
